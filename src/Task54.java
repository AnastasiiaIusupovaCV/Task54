 ...
 * @author a.yusupova
 */
public class Task54 extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Task54.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
